...
enum {
  ...
  InterestPacketSizeMin = 155,
  InterestPacketSizeMax = 156,
  InterestPacketSizeAvg = 157,
  InterestPacketSizeStdDev = 158,
  DataPacketSizeMin = 155,
  DataPacketSizeMax = 156,
  DataPacketSizeAvg = 157,
  DataPacketSizeStdDev = 158,
  InterestComponentSizeMin = 155,
  InterestComponentSizeMax = 156,
  InterestComponentSizeAvg = 157,
  InterestComponentSizeStdDev = 158,
  DataComponentSizeMin = 159,
